...
@WebServlet(name = "ServletCrearAlumnos", urlPatterns = {"/crearalumnos"})
public class ServletCrearAlumnos extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(cc.agregarAlumno(nuevoAlumno)) {
            response.sendRedirect("alumnos.jsp");
        } else {
            response.sendRedirect("a_alumno.jsp");
        }
